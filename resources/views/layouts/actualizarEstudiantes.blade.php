                        ...
                        fetch('http://127.0.0.1:8000/api/students')
                            ...
                            .then(data => {
                                ...
                                data.forEach(item => {
                                    ...
                                    texto.textContent = `${item.id} - ${item.Nombre} - ${item.Apellido} - ${item.Edad} - ${item.Email}`;
                                    ...
                                    iconoEditar.addEventListener('click', function() {
                                        // Crear un formulario
                                        let data = { id: item.id, nombre: item.Nombre, apellido: item.Apellido, edad: item.Edad, email: item.Email };
                                        let form = document.createElement("form");
                                        form.method = "GET";
                                        form.action = "/adminCursos/public/actualizarEstudiantes2";
